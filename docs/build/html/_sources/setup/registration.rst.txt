...
- (long-term ppl) VCG google drive
  ...
  * add your personal information `[link] <https://docs.google.com/spreadsheet/ccc?key=0AtePNvrCJCcedEtVdjlMV0tKWmVBamI4N25fTjdVelE&usp=drive_web#gid=0>`_.
...
* Email client
    ...
    * `Thunderbird access <https://uit.stanford.edu/service/office365/configure/thunderbird>`_. (replace standford with harvard)
